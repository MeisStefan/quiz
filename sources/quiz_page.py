...
def start_quiz(quiz_model, root):
    myLabel2 = Label(root, text= QUIZ_PAGE_TITLE, font= QUIZ_PAGE_TITLE_FONT)
    myLabel2.pack()
    quiz_model.store_questions_label(myLabel2)
    myButton1 = Button(root, text= QUIZ_PAGE_ANSWERS_TITLES[0], font= QUIZ_PAGE_ANSWERS_FONT, command=lambda: select_answer(1))
    quiz_model.store_answer_button(myButton1)
    myButton1.pack()
    myButton2 = Button(root, text =QUIZ_PAGE_ANSWERS_TITLES[1], font=QUIZ_PAGE_ANSWERS_FONT, command=lambda: select_answer(2))
    quiz_model.store_answer_button(myButton2)
    myButton2.pack()
    myButton3 = Button(root, text =QUIZ_PAGE_ANSWERS_TITLES[2], font=QUIZ_PAGE_ANSWERS_FONT, command=lambda: select_answer(3))
    quiz_model.store_answer_button(myButton3)
    myButton3.pack()
    myButton4 = Button(root, text =QUIZ_PAGE_ANSWERS_TITLES[3], font=QUIZ_PAGE_ANSWERS_FONT, command=lambda: select_answer(4))
